...
def _spawn_from_usd_file(
    ...
    **kwargs,
    ...
    if cfg.fixed_tendons_props is not None:
        # transition routing: new fragment list -> apply_*; legacy single cfg -> modify_*
        fixed_tendon_frags = (
            cfg.fixed_tendons_props if isinstance(cfg.fixed_tendons_props, (list, tuple)) else [cfg.fixed_tendons_props]
        )
    ...
    if cfg.spatial_tendons_props is not None:
        ...
        spatial_tendon_frags = (
            ...
            if isinstance(cfg.spatial_tendons_props, (list, tuple))
